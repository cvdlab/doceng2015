...
% In this paper we describe the design and the development of the new module VisProSL (Visual Programming Service Link) of the visual programming platform 


% In particolare il presente lavoro

% jointly developed by {\bf SoGeI} ({\bf So}cietà {\bf Ge}nerale d’{\bf I}nformatica), fully owned by the Ministry of Economy and Finance, and the {\bf CVDLAB} (Computational Visual Design Laboratory) of the Computer Science and Automation Department of “Roma Tre” University è ispirato dalle necessità di SoGeI stessa, 


% AGGIUNGERE LE POSIZIONI DI BOTTARE RIVISITATE
