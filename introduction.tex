...
of positioning systems like GNSS (Global Navigation Satellite system), Wi-Fi, and 
...
Italy, so requiring strict access control policies, which include the recording and 
