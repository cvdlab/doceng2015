...
Marco Virgadamo\\
       ...
       \affaddr{Rome, Italy}\\
       \email{mar.virgadamo@stud.uniroma3.it}\\
\alignauthor
Marco Sportillo\\
       \affaddr{Dipartimento di Ingegneria}\\
       \affaddr{Universit\`a Roma Tre}\\
       \affaddr{Rome, Italy}\\
       \email{mar.sportillo@stud.uniroma3.it}\\
\alignauthor 
Federico Spini\\
       \affaddr{Dipartimento di Ingegneria}\\
       \affaddr{Universit\`a Roma Tre}\\
...
\keywords{Document format, indoor cartography, indoor navigation, IoT monitoring, multiperson-tracking}
