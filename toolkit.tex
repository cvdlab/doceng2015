...
\item
 ...
 correspondence of three real word points to three points included
...
\item
 ...
 impera approach adopted (as described below).
\item
...
Every HIJSON Element of the input HJSON document has a dynamic
